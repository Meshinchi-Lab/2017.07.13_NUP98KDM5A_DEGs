...
PROJHOME <- file.path(PROJHOME,"2017.07.13_NUP98KDM5A_DEGs")
```
...
```{r}
CDE.0531 <- read.csv(file.path(REFS, "00_Archive/00_Old/TARGET_AML_current_asof_june30_2016_UPDATED_CLEAN_4.19.18.csv"),
...
```{r}
CDE.1031 <- read.csv(file.path(REFS, "00_Archive/00_Old/older_versions/TARGET_AML_1031_CDE_cleaned_7.06.2018.csv"),
                     stringsAsFactors = FALSE)
colnames(CDE.1031)[grep("^NUP98.KDM5A", colnames(CDE.1031))] <- "NUP98.KDM5A"
colnames(CDE.1031)[grep("^NUP98.NSD1", colnames(CDE.1031))] <- "NUP98.NSD1"
# CDE.1031 <- read.csv(file.path(REFS, "00_Archive/00_Old/AAML1031_Target_CDEs_with_HiAR_and_PrimaryCyto_withFusionCalls_10.11.2018.csv"),
#                      stringsAsFactors = FALSE)
...
```{r}
CDE.1031 %>% 
  select(USI,NUP98.NSD1, NUP98.KDM5A) %>% 
  arrange(desc(NUP98.KDM5A), desc(NUP98.NSD1)) %>% 
  filter(NUP98.KDM5A!="Unknown") %>% 
  # write.csv(., file.path(PROJHOME,"Sanne_Noort_RNA-seq_Sample_Manifest.csv"), row.names = F)
```
...
```{r}
HD.0531 <- read.csv(file.path(HOME,"0000.00.03_Expression_Matrices/TARGET_AML_DxSamples_dupGenesRemoved_TPM_Aug2014.csv"), 
...
```{r}
LD.0531 <- read.csv(file.path(HOME,"0000.00.03_Expression_Matrices/TARGET_AML_AAML0531_dupGenesRemoved_TPM.csv"),
                    stringsAsFactors = FALSE, row.names = 1)
...
```{r}
HD.1031 <- read.csv(file.path(HOME,"0000.00.03_Expression_Matrices/TARGET_AML_AAML1031_dupGenesRemoved_TPM.csv"), 
                    stringsAsFactors = FALSE, row.names = 1)
...
```{r}
HD.0531.cts <- read.csv(file.path(HOME,"0000.00.03_Expression_Matrices/TARGET_AML_DxSamples_dupGenesRemoved_FractionalCounts_Aug2014.csv"),
                        stringsAsFactors = FALSE,
                        row.names = 1)
...
```{r}
LD.0531.cts <- read.csv(file.path(HOME,"0000.00.03_Expression_Matrices/TARGET_AML_AAML0531_dupGenesRemoved_FractionalCounts.csv"),
                        stringsAsFactors = FALSE,
                        row.names = 1)
...
```{r}
HD.1031.cts <- read.csv(file.path(HOME,"0000.00.03_Expression_Matrices/TARGET_AML_AAML1031_dupGenesRemoved_FractionalCounts.csv"),
                        stringsAsFactors = FALSE,
                        row.names = 1)
...
```{r}
table(CDE.1031$USI %in% colnames(HD.1031.cts))
```
